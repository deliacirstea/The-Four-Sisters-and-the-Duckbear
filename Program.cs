...
Console.WriteLine("Let's count some eggs today! Shall we?");

Console.WriteLine("How many chocolate eggs have you gathered today)");
string chocoEggs = Console.ReadLine();
float Eggs = float.Parse(chocoEggs);


float total = Eggs / 4;
float duckbear = Eggs % 4;

Console.WriteLine("Each of you will receive " + total + " eggs today. \nCome back tomorrow for more!");
Console.WriteLine("The duckbear will receive " + duckbear + "eggs today.");

//Aditional you could follow the book path
